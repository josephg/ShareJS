# This is a set of test helpers. All the test helpers are included
# directly in this file except for the randomizer, which should be
# required directly.
...
# callback.
exports.makePassPart = (n, callback) ->
  remaining = n
  ->
    remaining--
    if remaining == 0
