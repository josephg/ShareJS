...
(function() {
  var Range, applyToShareJS, errorCallback;
  ...
  applyToShareJS = function(editorDoc, delta, doc) {
    ...
    callback = function(error) {
      return error && errorCallback && errorCallback(error);
    };
    switch (delta.action) {
      case 'insertText':
        doc.insert(pos, delta.text, callback);
        break;
      case 'removeText':
        doc.del(pos, delta.text.length, callback);
        break;
      case 'insertLines':
