...
(function() {
  var AttributePool, BCSocket, Changeset, Connection, Doc, MicroEvent, ReconnectingWebSocket, SockJS, WebSocket, append, attribsToTokens, bootstrapTransform, checkValidComponent, checkValidOp, etherpad, exports, hasBCSocket, hasSockJS, invertComponent, nextTick, socketImpl, strInject, text, transformComponent, transformPosition, types,
    __slice = [].slice,
