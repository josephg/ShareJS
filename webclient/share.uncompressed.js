  ...
  Doc = (function() {
    ...
    function Doc(connection, name, openData) {
      ...
      this.shout = function(msg) {
        return Doc.prototype.shout.apply(_this, arguments);
      };
      this.flushCursor = function() {
        return Doc.prototype.flushCursor.apply(_this, arguments);
      };
      this.flush = function() {
        return Doc.prototype.flush.apply(_this, arguments);
      };
      openData || (openData = {});
