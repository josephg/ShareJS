...
(function() {
  ...
  SubDoc.prototype.insert = function(path, value, cb, meta) {
    return normalizeArgs(this, arguments, function(path, value, cb){
      return this.context.insert(path, value, cb, meta);
    });
  };

  SubDoc.prototype.remove = function(path, len, cb, meta) {
    return normalizeArgs(this, arguments, function(path, len, cb) {
      return this.context.remove(path, len, cb, meta);
    }, 2);
  };

  SubDoc.prototype.push = function(path, value, cb, meta) {
    return normalizeArgs(this, arguments, function(path, value, cb) {
  ...
  _type.api = {
    ...
    remove: function(path, len, cb, meta) {
      return normalizeArgs(this, arguments, function(path, len, cb) {
    ...
    insert: function(path, value, cb, meta) {
      return normalizeArgs(this, arguments, function(path, value, cb) {
        var pos = path.pop();
        var _ref = traverse(this.getSnapshot(), path);
        var elem = _ref.elem;
    ...
    on: function (path, event, cb) {
      return this.addListener(path, event, cb);
    },
