...
(function() {
  ...
  // given a path represented as a dotted string, an array or a number, normalize to an array
  // dotted strings are split on dots, and whole numbers are converted to integers.
  ...
  _type.api = {
      ...
      return normalizeArgs(this, arguments, function(path, len, cb) {
        ...
        if (len === null || len === undefined) {
          ...
          if (typeof elem[key] === 'string') {
            ...
            console.log("REMOVE MULTI", pos, len, ops);
    ...
    getText: function(path) {
      return normalizeArgs(this, arguments, function(path) {
        console.warm("Deprecated. Use `get()` instead");
    ...
    deleteText: function(path, length, pos, cb) {
      return normalizeArgs(this, arguments, function(path, length, pos, cb) {
        console.warm("Deprecated. Use `remove(path, length, cb)` instead");
        var _ref = traverse(this.getSnapshot(), path);
        var op = [
          {
            p: path.concat(pos),
