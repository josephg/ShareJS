...
(function() {
  ...
  SubDoc.prototype.insert = function(path, value, meta, cb) {
    return normalizeArgs(this, arguments, function(path, value, cb){
      return this.context.insert(path, value, meta, cb);
    });
  };

  SubDoc.prototype.remove = function(path, len, meta, cb) {
    return normalizeArgs(this, arguments, function(path, len, cb) {
      return this.context.remove(path, len, meta, cb);
    }, 2);
  };

  SubDoc.prototype.push = function(path, value, meta, cb) {
    return normalizeArgs(this, arguments, function(path, value, cb) {
  ...
  _type.api = {
    ...
    remove: function(path, len, meta, cb) {
      return normalizeArgs(this, arguments, function(path, len, cb) {
    ...
    insert: function(path, value, meta, cb) {
      return normalizeArgs(this, arguments, function(path, value, cb) {
        var pos = path.pop();
        var _ref = traverse(this.getSnapshot(), path);
        var elem = _ref.elem;
