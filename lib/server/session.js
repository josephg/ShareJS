  ...
  switch (req.a) {
    ...
    case 'qsub':
      ...
      agent.query(index, req.q, qopts, function(err, emitter) {
        ...
        // emitter.results). Callback called in a process.nextTick(), at the earliest.
        var data = self._processQueryResults(emitter.results, qopts);
        ...
        //self._reply(req, null, {id:qid, data:emitter.results, extra:emitter.extra});
