...
window.sharejs.Doc.prototype.attachTextarea = function(elem, ctx) {
  ...
  var genOp = function(event) {
    ...
    setTimeout(function() {
      ctx.setSelection([elem.selectionStart, elem.selectionEnd]);
      // if (elem.selectionStart === elem.selectionEnd) {
      //   ctx.setSelection([elem.selectionStart, elem.selectionStart]);
      // } else {
      //   if (elem.selectionDirection == 'backward')
      //     ctx.setSelection([elem.selectionEnd, elem.selectionStart]);
      //   else
      //     ctx.setSelection([elem.selectionStart, elem.selectionEnd]);
      // }
  ...
  // textinput, keydown and keyup are all needed for normal typing.
  // select = ??
  // cut and paste, obviously.
  // click and focus are important for cursor stuff
  var eventNames = ['textInput', 'keydown', 'keyup', 'select', 'cut', 'paste', 'click', 'focus'];
