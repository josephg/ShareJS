 ...
 * documents.
 *
 * We create a connection with a browserchannel object
 *   connection = new sharejs.Connection(browserchannel)
 * We wait for the connection to connect
 *   connection.on('connected', ...)
 * and are then able to work with shared documents
 ...
 *
 * The socket is a BrowserChannel like object, used to send and receive
 * messages. This method sets the onopen, onclose, onmessage and onerror
 * callbacks on the socket object.
 *
 * @param socket Like BrowserChannel object
